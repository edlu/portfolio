...
<template>
  <main class="padding-1x padding-4x-tablet-portrait gap-2x gap-4x-tablet-portrait">
            ...
            <div class="project-summary card">
                ...
                <div class="project-summary__achievements padding-2x padding-1x-mobile">
                    <ul>
                        ...
                        <li>Product continues to thrive and be used by millions today</li>
                    </ul>
                </div>
            </div>
        </section>
        ...
        <section>
            <img :src="dailyDeviceHero" alt="Yahoo! Daily Fantasy devices" class="img-full-width" data-aos="fade-up">
        </section>

    <section class="margin-bottom-2x">
        <h3>Planning for Social</h3>
        ...
        <img :src="dailyHighLevelFlow" alt="Yahoo! Daily Fantasy social sketch" class="img-full-width" data-aos="fade-up">
    </section>
    <section class="margin-bottom-2x">
        <h3>Screens</h3>

        <p>For the more detailed flows of the app we partnered with our internal UX Research team and tested flows extensively starting with wireframe paper prototypes.  Later we moved to increasingly higher fidelity methods including visually designed paper prototyping and then digital.</p>
        ...
        <div class="group gap-2x flex-wrap flex-justify-center flex-align-center margin-bottom-4x">
                <img :src="dailySplash" alt="Yahoo! Daily Fantasy Splash Page" class="img-responsive" data-aos="fade-up" data-aos-delay="100">
                <img :src="dailyMyContests" alt="Yahoo! Daily Fantasy My Contests Page" class="img-responsive" data-aos="fade-up" data-aos-delay="200">
                <img :src="dailyContests" alt="Yahoo! Daily Fantasy Contests Page" class="img-responsive" data-aos="fade-up" data-aos-delay="300">
                <img :src="dailyLineup" alt="Yahoo! Daily Fantasy Lineup Page" class="img-responsive" data-aos="fade-up" data-aos-delay="400">
                <img :src="dailyH2HContest" alt="Yahoo! Daily Fantasy Head to Head Contest Result Page" class="img-responsive" data-aos="fade-up" data-aos-delay="500">
                <img :src="dailyPlayer" alt="Yahoo! Daily Fantasy Player Page" class="img-responsive" data-aos="fade-up" data-aos-delay="600">
        </div>
    </section>
